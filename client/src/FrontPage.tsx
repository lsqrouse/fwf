...
export default function FrontPage () {
  ...
  const handleSubmitCreate = () => {
    ...
    fetch('/api/lobby/create')
      ...
      .then((data) => {
        ...
        dispatch({type: 'updatePlayer', payload: {nickname: nickname, isAlive: true, host: true, card1: 0, card1Alive: true, card2: 0, card2Alive: true, numCoins: 3, numCards: 2}})
  ...
  const handleSubmit = () => {
    ...
    .then((data) => {
      console.log("got data from api: ", data)
      dispatch({type: 'updateLobby', payload: data})
      dispatch({type: 'updatePlayer', payload: {nickname: nickname, isAlive: true, host: false, card1: 0, card1Alive: true, card2: 0, card2Alive: true, numCoins: 3, numCards: 2}})
